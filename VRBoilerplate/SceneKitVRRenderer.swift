...
class SceneKitVRRenderer: NSObject, GVRCardboardViewDelegate {
    ...
    func cardboardViewFromARTransform(_ cardboardView: GVRCardboardView!, draw eye: GVREye, with headTransform: GVRHeadTransform!, slamTransform: GLKMatrix4) {
...
//        print("eye \(eye) projectionMatrix \(projection_matrix)")
